...
| `high_level_policy.hold_s` | Final validated-reference grace period before the watchdog pauses `POLICY`; covers transient host inference and transport delays | `3.0` |
